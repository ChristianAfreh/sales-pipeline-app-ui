...
const SalesProcessesPage = async () => {
            ...
            <div>
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink asChild>
                                <Link href="/sales-processes">Sales Processes</Link>
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>GridList</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
            {/* <div className="mt-4 mx-auto">
                <h1 className="text-xl font-bold">Sales Processes</h1>
                <p className="text-muted-foreground">Manage and optimize your sales workflows</p>
...
export default SalesProcessesPage;